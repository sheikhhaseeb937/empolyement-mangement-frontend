...
// import GoogleIcon from './GoogleIcon'; // Ensure this path is valid
...
// try {
//   const response = await axios.post("http://localhost:5000/api/loginEmployee",{
//     email,
//     password
//   })
...
const handleSubmit = async () => {
  console.log({ email, password });
  try {
    const response = await axios.post(`${import.meta.env.VITE_BASE_URL}/api/loginEmployee`, {
      email,
      password,
    });
        ...
        >
          ...
          <Box component="footer" sx={{ py: 3 }}>
            <Typography level="body-xs" sx={{ textAlign: 'center' }}>
              Soluation {new Date().getFullYear()}
            </Typography>
          </Box>
        </Box>
      </Box>
